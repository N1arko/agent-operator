...
Подготовлен worker `0.1.1` с запуском актуального npm Codex через Node.js.
Требуется установить обновление на Windows и повторить тест.

## Контрольные точки

### CP-WIN-01 — Подключить реальный Windows-ноутбук

**Статус:** Windows подключён, ожидается обновление worker до `0.1.1`.
