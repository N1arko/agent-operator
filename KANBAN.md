...
2. **AOP-092:** настроить автозапуск и восстановление Windows-worker.
3. **AOP-052–AOP-056, AOP-071:** реализовать временные вложения для офисных
   файлов вне Git.
4. **AOP-084, AOP-091:** включить backup SQLite и подготовить инструкцию
   эксплуатации.
5. **AOP-073:** вернуться к live-обновлению Desktop при появлении чистого
...
- [ ] **AOP-092:** Настроить автозапуск и восстановление Windows-worker.
